...
class CustomComparator{
  ...
  public:
  bool operator()(DLLNode *NodeA, DLLNode *NodeB){
...
class Solution {
  public:
    ...
    DLLNode *sortAKSortedDLL(DLLNode *head, int k) {
        ...
        priority_queue<DLLNode*, vector<DLLNode*>, CustomComparator>pq;
        DLLNode *nwHead=nullptr, *tail=nullptr;
